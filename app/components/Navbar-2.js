  ...
  return (
    <nav className='bg-white py-4 px-4 sm:px-5 lg:px-10 absolute w-full flex justify-between items-end z-50'>
      ...
      <div className='hidden lg:flex items-center'>
        ...
        <Link href="/activeEletions" className="text-lg text-[#0E5D8A] hover:text-[#0E5D8A]/60 font-bold tracking-wider mx-2 border-b-2 border-[#0E5D8A] hover:border-[#0E5D8A]/60">Upcomming Election</Link>
